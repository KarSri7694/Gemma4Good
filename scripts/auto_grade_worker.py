...
from app.assessment_sync import enqueue_new_google_form_responses, process_next_queued_response
...
def main() -> None:
    ...
    llama_model_name = "Gemma-4-E4B-Q4_K_M"
    ...
    while True:
        enqueued = enqueue_new_google_form_responses()
        processed = 0
        while True:
